...
def make_dir_tree(skip=4):
    ...
    for d in dirs:
        ...
        os.mkdir("morphes")
        cmd = (
            "echo 0| trjconv -f traj.trr -s topol.tpr -skip %d -b 2001 -sep -o morphes/frame.gro"
            % skip
        )
...
def main(argv):
    ...
    options = [
        Option("-sw_time", "real", 50.0, "switching time to use for FGTI runs"),
