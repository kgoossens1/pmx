    ...
    for ffile in ffs:
        ...
        for at1 in ff.atoms:
            if at1.type in list(atoms.keys()):  # check if atom type already exists
                ...
                if (
                    at1.type == at2.type
                    and at1.sigmaA == at2.sigmaA
                    and at1.epsA == at2.epsA
                    and at1.sigmaB == at2.sigmaB
                    and at1.epsB == at2.epsB
                ):
                    continue
                else:
                    sys.stdout.write(
                        "Found two atoms of type %s, but they have different parameters, consider renaming atom types\n"
                        % at1.type
                    )
            else:
                atoms[at1.type] = at1
