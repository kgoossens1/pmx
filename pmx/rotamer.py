...
_aa_chi = {
    "CYS": {1: [("N", "CA", "CB", "SG"), ["1HB", "2HB", "SG", "HG", "1HG"]]},
    "ASP": {
    ...
    "GLU": {
        1: [
            ("N", "CA", "CB", "CG"),
            ["1HB", "2HB", "CG", "1HG", "2HG", "CD", "OE1", "OE2", "HE2"],
        ],
    ...
    "HIS": {
        ...
        2: [
            ("CA", "CB", "CG", "ND1"),
            ["CD2", "ND1", "HD2", "HD1", "NE2", "CE1", "HE2", "HE1"],
        ],
    },
    "HIE": {
        1: [
            ("N", "CA", "CB", "CG"),
            ["1HB", "2HB", "CG", "CD2", "ND1", "HD2", "NE2", "CE1", "HE2", "HE1"],
        ],
        2: [
            ("CA", "CB", "CG", "ND1"),
            ["CD2", "ND1", "HD2", "NE2", "CE1", "HE2", "HE1"],
        ],
    },
    "HID": {
        1: [
            ("N", "CA", "CB", "CG"),
            ["1HB", "2HB", "CG", "CD2", "ND1", "HD2", "HD1", "NE2", "CE1", "HE1"],
        ],
        2: [
            ("CA", "CB", "CG", "ND1"),
            ["CD2", "ND1", "HD2", "HD1", "NE2", "CE1", "HE1"],
        ],
    },
    "HIP": {
        1: [
    ...
    "LYS": {
        ...
        3: [
            ("CB", "CG", "CD", "CE"),
            ["1HD", "2HD", "CE", "1HE", "2HE", "NZ", "1HZ", "2HZ", "3HZ"],
        ],
    ...
    "LYN": {
        ...
        2: [
            ("CA", "CB", "CG", "CD"),
            ["1HG", "2HG", "CD", "1HD", "2HD", "CE", "1HE", "2HE", "NZ", "1HZ", "2HZ"],
        ],
        3: [
            ("CB", "CG", "CD", "CE"),
            ["1HD", "2HD", "CE", "1HE", "2HE", "NZ", "1HZ", "2HZ"],
        ],
    ...
    "LEU": {
        ...
        2: [
            ("CA", "CB", "CG", "CD1"),
            ["HG", "CD1", "1HD1", "2HD1", "3HD1", "CD2", "1HD2", "2HD2", "3HD2"],
        ],
    },
    "MET": {
        1: [
            ("N", "CA", "CB", "CG"),
            ["1HB", "2HB", "CG", "1HG", "2HG", "SD", "CE", "1HE", "2HE", "3HE"],
        ],
    ...
    "GLN": {
        1: [
            ("N", "CA", "CB", "CG"),
            ["1HB", "2HB", "CG", "1HG", "2HG", "CD", "OE1", "NE2", "1HE2", "2HE2"],
        ],
        2: [
            ("CA", "CB", "CG", "CD"),
            ["1HG", "2HG", "CD", "OE1", "NE2", "1HE2", "2HE2"],
        ],
    ...
    "ARG": {
        ...
        4: [
            ("CG", "CD", "NE", "CZ"),
            ["HE", "CZ", "NH1", "NH2", "1HH1", "1HH2", "2HH1", "2HH2"],
        ],
    },
    "SER": {1: [("N", "CA", "CB", "OG"), ["1HB", "2HB", "OG", "HG", "1HG"]]},
    "THR": {
        1: [
            ("N", "CA", "CB", "OG1"),
            ["HB", "OG1", "HG1", "CG2", "1HG2", "2HG2", "3HG2"],
        ]
    },
    "VAL": {
        1: [
            ("N", "CA", "CB", "CG1"),
            ["HB", "CG1", "1HG1", "2HG1", "3HG1", "CG2", "1HG2", "2HG2", "3HG2"],
        ]
    },
    "TRP": {
        1: [
    ...
    "TYR": {
        ...
        2: [
            ("CA", "CB", "CG", "CD1"),
            ["CD1", "HD1", "CD2", "HD2", "CE1", "HE1", "CE2", "HE2", "CZ", "OH", "HH"],
        ],
    },
}


def make_bbdep(min_val=0.01):
...
def get_rotamers(bbdep, resname, phi, psi, residue=False, hydrogens=True, full=False):
    key = (round(phi * 0.1, 0) * 10, round(psi * 0.1, 0) * 10)
...
def mini_nb(model, mol, cutoff):
    ...
    for atom in model.atoms:
        if (
            atom.resname not in ["SOL", "NaS", "ClS", "NA", "CL", "NaJ", "ClJ"]
            and atom not in mol.atoms
            and atom.x[0] >= c[0] - cutoff
            and atom.x[0] <= c[0] + cutoff
            and atom.x[1] >= c[1] - cutoff
            and atom.x[1] <= c[1] + cutoff
            and atom.x[2] >= c[2] - cutoff
            and atom.x[2] <= c[2] + cutoff
        ):
            nb_list.append(atom)
    return nb_list
...
def check_overlaps(model, mol, nb_list):
    ...
    for atom in mol.atoms:
        if (
            atom.name not in ["N", "CA", "C", "O", "H", "CB", "HA"]
            and atom.symbol != "H"
        ):
            nat += 1
            for at in nb_list:
...
def mutate(residue, new_aa, bbdep):
    ...
    psi = residue.get_psi()
    m = residue.model
    rotamers = get_rotamers(
        bbdep, new_aa, phi, psi, residue=residue, full=True, hydrogens=False
    )
