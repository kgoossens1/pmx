...
options = [
    Option(
        ...
        "string",
        "default_string",
        "Description of what this string options is doing",
    ),
    ...
    Option(
        ...
        "rvec",
        [2.5, 3.0, -1.0],
        "Description of what this real vector option is doing",
    ),
    Option(
        "-vec2",
        "ivec",
        [2, 3, 0],
        "Description of what this int vector option is doing",
    ),
    Option(
        "-vec3",
        "svec",
        ["a", "b", "c"],
        "Description of what this string vector option is doing",
    ),
]
